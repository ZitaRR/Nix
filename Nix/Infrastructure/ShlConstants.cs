...
internal static class ShlConstants
{
    ...
    internal const string SEASONS_ENDPOINT = "api/sports-v2/season-series-game-types-filter";
    internal const string GAME_INFO_ENDPOINT = "api/sports-v2/game-schedule?seasonUuid={0}&seriesUuid=qQ9-bb0bzEWUk&gameTypeUuid={1}&gamePlace=all&played=all";
